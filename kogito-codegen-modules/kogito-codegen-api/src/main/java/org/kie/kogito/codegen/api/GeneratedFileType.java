 ...
 * It also provides default reusable instances for generic types {@link GeneratedFileType.Category#SOURCE},
 * {@link GeneratedFileType.Category#RESOURCE}
...
public interface GeneratedFileType {
    ...
    class StaticGeneratedFileType implements GeneratedFileType {
        ...
        public boolean equals(Object o) {
            ...
            return canHotReload == that.canHotReload() && name.equals(that.name()) && category == that.category()
                    && customizable == that.isCustomizable();
        }
