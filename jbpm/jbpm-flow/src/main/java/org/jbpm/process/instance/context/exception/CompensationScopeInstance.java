...
public class CompensationScopeInstance extends ExceptionScopeInstance {
            ...
            try {
                ...
                if (handlerNode instanceof BoundaryEventNode) {
                    ...
                    if (completedIds.contains(((NodeImpl) ((Node) handlerNode).getParentContainer()).getMetaData("UniqueId"))) {
                        NodeInstance subProcessNodeInstance = ((NodeInstanceContainer) nodeInstanceContainer).getNodeInstance(
                                (org.kie.api.definition.process.Node) ((Node) handlerNode).getParentContainer());
                        ...
                        EventSubProcessNodeInstance eventNodeInstance =
                                (EventSubProcessNodeInstance) compensationHandlerNodeInstance;
    ...
    private void throwWorkflowRuntimeException(NodeInstanceContainer nodeInstanceContainer, ProcessInstance processInstance,
