...
public class PublishEventTest extends AbstractCodegenTest {
    ...
    public void testBusinessRuleProcessStartToEnd() throws Exception {
        ...
        assertThat(body.getNodeInstances()).hasSize(3).extractingResultOf("getNodeType").contains("StartNode", "RuleSetNode",
                "EndNode");
    ...
    public void testCompensationProcess() throws Exception {
        ...
        assertThat(body.getNodeInstances()).hasSize(9).extractingResultOf("getNodeType").contains("StartNode", "ActionNode",
                "BoundaryEventNode", "EndNode");
    ...
    public void testExclusiveGatewayStartToEnd() throws Exception {
        ...
        assertThat(body.getNodeInstances()).hasSize(6).extractingResultOf("getNodeType").contains("StartNode", "ActionNode",
                "Split", "Join", "EndNode", "WorkItemNode");
    ...
    protected ProcessInstanceEventBody assertProcessInstanceEvent(DataEvent<?> event, String processId, String processName,
            Integer state) {
    ...
    protected UserTaskInstanceEventBody assertUserTaskInstanceEvent(DataEvent<?> event, String taskName, String taskDescription,
            String taskPriority, String taskState, String processId, String nodeName) {
