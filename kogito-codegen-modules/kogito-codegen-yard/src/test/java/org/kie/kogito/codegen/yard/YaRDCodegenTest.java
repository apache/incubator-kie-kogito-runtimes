...
public class YaRDCodegenTest {
    ...
    public void testTwoFiles(KogitoBuildContext.Builder contextBuilder) {
        ...
        Collection<GeneratedFile> generate = codeGenerator.generate(); // TODO
    ...
    public void isEmpty(KogitoBuildContext.Builder contextBuilder) {
        ...
        YaRDCodegen emptyCodeGenerator = YaRDCodegen.ofCollectedResources(context, Collections.emptyList());
        ...
        YaRDCodegen codeGenerator = getYaRDCodegen("src/test/resources/YaRD/models/vacationDays", contextBuilder);
    ...
    public void generateAllFiles(KogitoBuildContext.Builder contextBuilder) {
        ...
        Collection<String> expectedResources = new ArrayList<>(Arrays.asList("decision/InputSet.java",
                ...
                "org/kie/kogito/app/YaRDModelResourcesProvider.java"));
        ...
        //        assertThat(((YaRDContainerGenerator) codeGenerator.section().get()).getClassesForManualReflection()).containsAll(expectedStronglyTypeClassesForReflection);
    }

    @ParameterizedTest
    @MethodSource("org.kie.kogito.codegen.api.utils.KogitoContextTestUtils#contextBuilders")
    public void doNotGenerateTypesafeInfo(KogitoBuildContext.Builder contextBuilder) {
        YaRDCodegen codeGenerator = getYaRDCodegen("src/test/resources/decision/alltypes/", contextBuilder);
    ...
    public void givenADMNModelWhenMonitoringIsActiveThenGrafanaDashboardsAreGenerated(KogitoBuildContext.Builder contextBuilder) throws Exception {
        YaRDCodegen decisionCodeGenerator = getYaRDCodegen("src/test/resources/decision/models/vacationDays",
    ...
    public void resilientToDuplicateDMNIDs(KogitoBuildContext.Builder contextBuilder) {
        YaRDCodegen codeGenerator = getYaRDCodegen("src/test/resources/decision-test20200507", contextBuilder);
    ...
    public void testNSEW_positive(KogitoBuildContext.Builder contextBuilder) {
        ...
        YaRDCodegen codeGenerator = getYaRDCodegen("src/test/resources/decision-NSEW", contextBuilder);
    ...
    protected AbstractStringAssert<?> assertNotEmptySectionCompilationUnit(String sourcePath, KogitoBuildContext.Builder contextBuilder) {
        YaRDCodegen codeGenerator = getYaRDCodegen(sourcePath, contextBuilder);
        return assertNotEmptySectionCompilationUnit(codeGenerator);
    }

    protected AbstractStringAssert<?> assertNotEmptySectionCompilationUnit(YaRDCodegen codeGenerator) {
    ...
    protected void assertRestResource(YaRDCodegen codeGenerator) {
    ...
    private List<GeneratedFile> generateTestDashboards(YaRDCodegen codeGenerator, int expectedDashboards) {
