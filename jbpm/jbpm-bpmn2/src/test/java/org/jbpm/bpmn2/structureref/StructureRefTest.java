...
public class StructureRefTest extends JbpmBpmn2TestCase {
    ...
    public void testInvalidBooleanStructureRefOnStartVerifyErrorMsg() throws Exception {
        ...
        try {
            ...
            assertEquals("Variable 'test' has incorrect data type expected:java.lang.Boolean actual:java.lang.String",
                    e.getMessage());
        }
    ...
    public void testNotExistingBooleanStructureRefOnWIComplete() throws Exception {
        ...
        try {
            ...
            assertEquals("Data output '" + wrongDataOutput + "' is not defined in process 'StructureRef' for task 'User Task'",
                    iae.getMessage());
        } catch (Exception e) {
            fail();
        }
