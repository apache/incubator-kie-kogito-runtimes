...
package org.kie.kogito.internal.event.process;
...
public class ContextAwareEventListener extends DefaultProcessEventListener {
    ...
    @Override
    public void afterNodeLeft(org.kie.kogito.internal.event.process.ProcessNodeLeftEvent event) {
        action.accept(this);
    }

    @Override
    public void afterVariableChanged(org.kie.kogito.internal.event.process.ProcessVariableChangedEvent event) {
        action.accept(this);
    }
