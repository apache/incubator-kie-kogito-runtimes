...
@TestTransaction
public class PostgreSQLQuarkusDataIsolationIT extends AbstractUserTaskInstancesDataIsolationIT {
    ...
    @Inject
    public PostgreSQLQuarkusDataIsolationIT(JPAUserTaskInstances userTaskInstances,
