...
public class ProtoStreamObjectMarshallingStrategyTest {
    ...
    public void testStringMarshalling() throws Exception {
        ...
        Object returned =
                protoStreamMarshallerStrategy.unmarshal("kogito.String", null, null, data, this.getClass().getClassLoader());
    ...
    public void testIntegerMarshalling() throws Exception {
        ...
        Object returned =
                protoStreamMarshallerStrategy.unmarshal("kogito.Integer", null, null, data, this.getClass().getClassLoader());
        assertNotNull(returned, "Unmarshalled value should not be null");
        assertEquals(value, returned, "Values should be the same");
    ...
    public void testLongMarshalling() throws Exception {
        ...
        Object returned =
                protoStreamMarshallerStrategy.unmarshal("kogito.Long", null, null, data, this.getClass().getClassLoader());
        assertNotNull(returned, "Unmarshalled value should not be null");
        assertEquals(value, returned, "Values should be the same");
    ...
    public void testDoubleMarshalling() throws Exception {
        ...
        Object returned =
                protoStreamMarshallerStrategy.unmarshal("kogito.Double", null, null, data, this.getClass().getClassLoader());
        assertNotNull(returned, "Unmarshalled value should not be null");
        assertEquals(value, returned, "Values should be the same");
    ...
    public void testFloatMarshalling() throws Exception {
        ...
        Object returned =
                protoStreamMarshallerStrategy.unmarshal("kogito.Float", null, null, data, this.getClass().getClassLoader());
        assertNotNull(returned, "Unmarshalled value should not be null");
        assertEquals(value, returned, "Values should be the same");
    ...
    public void testBooleanMarshalling() throws Exception {
        ...
        Object returned =
                protoStreamMarshallerStrategy.unmarshal("kogito.Boolean", null, null, data, this.getClass().getClassLoader());
        assertNotNull(returned, "Unmarshalled value should not be null");
        assertEquals(value, returned, "Values should be the same");
    ...
    public void testDateMarshalling() throws Exception {
        ...
        Object returned =
                protoStreamMarshallerStrategy.unmarshal("kogito.Date", null, null, data, this.getClass().getClassLoader());
        assertNotNull(returned, "Unmarshalled value should not be null");
        assertEquals(value, returned, "Values should be the same");
