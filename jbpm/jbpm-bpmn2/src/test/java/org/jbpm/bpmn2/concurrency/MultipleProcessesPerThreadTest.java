...
public class MultipleProcessesPerThreadTest {
    ...
    private static class HelloWorldProcessThread implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                kbuilder.add(ResourceFactory.newClassPathResource("BPMN2-MultiThreadServiceProcess-Timer.bpmn", getClass()),
                        ResourceType.BPMN2);
    ...
    private static class UserTaskProcessThread implements Runnable {
        ...
        public void run() {
            ...
            try {
                KnowledgeBuilder kbuilder = KnowledgeBuilderFactory.newKnowledgeBuilder();
                kbuilder.add(ResourceFactory.newClassPathResource("BPMN2-MultiThreadServiceProcess-Task.bpmn", getClass()),
                        ResourceType.BPMN2);
                InternalKnowledgeBase kbase = KnowledgeBaseFactory.newKnowledgeBase();
                kbase.addPackages(kbuilder.getKnowledgePackages());
