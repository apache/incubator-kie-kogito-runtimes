...
class CompensationEventListener implements KogitoEventListener {
        ...
        if (toCompensateNode != null || compensationScopeContainer != null) {
            ...
            if (compensationScope.getContextContainerId().equals(process.getId())) {
                ...
                if (toCompensateNode == null) {
                    ...
                    generatedInstances = createNodeInstanceContainers(
                            (org.kie.api.definition.process.Node) compensationScopeContainer, true);
                } else {
    ...
    private Stack<NodeInstance> createNodeInstanceContainers(org.kie.api.definition.process.Node toCompensateNode,
            boolean generalCompensation) {
        ...
        if (nestedNodes.isEmpty()) {
            ...
            parentInstance = (NodeInstanceContainer) ((WorkflowProcessInstanceImpl) getProcessInstance())
                    .getNodeInstance((org.kie.api.definition.process.Node) nestedNodes.pop());
        ...
        while (!nestedNodes.isEmpty()) {
            // generate
            childInstance = (NodeInstanceContainer) parentInstance
                    .getNodeInstance((org.kie.api.definition.process.Node) nestedNodes.pop());
