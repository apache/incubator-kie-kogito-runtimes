...
public class ProtostreamObjectMarshaller implements ObjectMarshallerStrategy {
    ...
    public Object marshall(Object unmarshalled) {
        ...
        return Any.newBuilder()
                .setTypeUrl(NAMESPACE + unmarshalled.getClass().getCanonicalName())
    ...
    public Object unmarshall(Object marshalled) {
        try {
            ...
            return ProtobufUtil.fromByteArray(context, bytes, 0, bytes.length, Class.forName(removeNamespace(data.getTypeUrl())));
