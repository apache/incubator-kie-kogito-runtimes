...
class TopicsInformationResourceGeneratorTest {
    ...
    void verifyProcessWithMessageEvent() {
        final ClassOrInterfaceDeclaration clazz =
                generateAndParseClass("/messageevent/IntermediateCatchEventMessage.bpmn2", 1, true);
        ...
        assertThat(clazz.getDefaultConstructor().get().getBody().getStatement(1).toExpressionStmt().get().getExpression()
    ...
    void verifyProcessWithMessageEventNoInjection() {
        final ClassOrInterfaceDeclaration clazz =
                generateAndParseClass("/messageevent/IntermediateCatchEventMessage.bpmn2", 1, false);
        ...
        assertThat(clazz.findFirst(MethodDeclaration.class,
                ...
                .findFirst(BlockStmt.class,
                        b -> b.getStatements().get(0).asExpressionStmt().getExpression().toString()
                                .contains("NoOpTopicDiscovery")))
                                        .isPresent();
    }
    ...
    void verifyProcessWithStartAndEndMessageEvent() {
        final ClassOrInterfaceDeclaration clazz =
                generateAndParseClass("/messagestartevent/MessageStartAndEndEvent.bpmn2", 2, true);
        ...
        assertThat(clazz.getDefaultConstructor().get().getBody().getStatement(2).toExpressionStmt().get().getExpression()
                .toString())
    ...
    void verifyProcessWithIntermediateThrowEventMessageEvent() {
        final ClassOrInterfaceDeclaration clazz =
                generateAndParseClass("/messageevent/IntermediateThrowEventMessage.bpmn2", 1, true);
    ...
    void verifyProcessWithBoundaryEventMessageEvent() {
        final ClassOrInterfaceDeclaration clazz =
                generateAndParseClass("/messageevent/BoundaryMessageEventOnTask.bpmn2", 1, true);
