...
public class ProtobufProcessMarshaller
    ...
    private static boolean persistWorkItemVars =
            Boolean.parseBoolean(System.getProperty("org.jbpm.wi.variable.persist", "true"));
    ...
    public void writeProcessInstances(MarshallerWriteContext context) throws IOException {
        ...
        List<org.kie.api.runtime.process.ProcessInstance> processInstances =
                new ArrayList<>(context.getWorkingMemory().getProcessInstances());
        ...
        for (org.kie.api.runtime.process.ProcessInstance processInstance : processInstances) {
            ...
            JBPMMessages.ProcessInstance _instance =
                    (JBPMMessages.ProcessInstance) ProcessMarshallerRegistry.INSTANCE.getMarshaller(processType)
    ...
    public void writeWorkItems(MarshallerWriteContext context) throws IOException {
        ...
        List<WorkItem> workItems = new ArrayList<WorkItem>(
                ((KogitoWorkItemManager) context.getWorkingMemory().getWorkItemManager()).getWorkItems());
    ...
    public List<ProcessInstance> readProcessInstances(MarshallerReaderContext context) throws IOException {
        ...
        for (JBPMMessages.ProcessInstance _instance : _pdata.getExtension(JBPMMessages.processInstance)) {
            ...
            ProcessInstance processInstance =
                    ProcessMarshallerRegistry.INSTANCE.getMarshaller(_instance.getProcessType()).readProcessInstance(context);
    ...
    public static Variable marshallVariable(MarshallerWriteContext context,
        ...
        if (value != null) {
            KogitoObjectMarshallingStrategy strategy =
                    (KogitoObjectMarshallingStrategy) context.getObjectMarshallingStrategyStore().getStrategyObject(value);
    ...
    public static Variable marshallVariablesMap(MarshallerWriteContext context, Map<String, Object> variables)
        ...
        for (String key : variables.keySet()) {
            ...
            if (variable != null) {
                KogitoObjectMarshallingStrategy strategy = (KogitoObjectMarshallingStrategy) context
                        .getObjectMarshallingStrategyStore().getStrategyObject(variable);
                Integer index = context.getStrategyIndex(strategy);
                builder.setStrategyIndex(index)
    ...
    public static VariableContainer marshallVariablesContainer(MarshallerWriteContext context, Map<String, Object> variables)
            throws IOException {
        ...
        for (String key : variables.keySet()) {
            ...
            if (variables.get(key) != null) {
                ObjectMarshallingStrategy strategy =
                        context.getObjectMarshallingStrategyStore().getStrategyObject(variables.get(key));
                Integer index = context.getStrategyIndex(strategy);
                builder.setStrategyIndex(index)
                        .setValue(ByteString.copyFrom(strategy.marshal(context.getStrategyContext().get(strategy),
                                (ObjectOutputStream) context,
    ...
    public static Object unmarshallVariableValue(MarshallerReaderContext context,
        ...
        KogitoObjectMarshallingStrategy strategy =
                (KogitoObjectMarshallingStrategy) context.getUsedStrategies().get(_variable.getStrategyIndex());
    ...
    public KogitoWorkItem readWorkItem(MarshallerReaderContext context) {
        try {
            ...
            throw new IllegalArgumentException("ClassNotFoundException while fetching work item instance : " + e.getMessage(),
                    e);
        }
    }
