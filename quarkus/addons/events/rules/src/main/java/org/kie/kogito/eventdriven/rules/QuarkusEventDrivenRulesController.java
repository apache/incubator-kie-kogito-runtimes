...
public class QuarkusEventDrivenRulesController extends EventDrivenRulesController {
    ...
    private void onPostConstruct() {
        setup(executors, config, eventEmitter, eventReceiver, newMapper(customizers));
    }

    private static ObjectMapper newMapper(Iterable<ObjectMapperCustomizer> customizers) {
        ObjectMapper mapper = CloudEventUtils.Mapper.newMapper();
