...
import org.kie.kogito.rules.units.impl.RuleUnitDescriptionImpl;
...
public class RuleUnitComponentFactoryImpl implements RuleUnitComponentFactory {
    ...
    public RuleUnitDescription createRuleUnitDescription(KiePackage pkg, Class<?> ruleUnitClass ) {
        return new RuleUnitDescriptionImpl((InternalKnowledgePackage) pkg, (Class<? extends RuleUnitData>) ruleUnitClass );
    }
