...
public class CallActivityHandler extends AbstractNodeHandler {
    ...
    public Object end(String uri, String localName, ExtensibleXmlParser parser) throws SAXException {
        ...
        while (xmlNode != null) {
            ...
            if ("multiInstanceLoopCharacteristics".equals(nodeName)) {
                ...
                //forEachNode.setMetaData("customAsync", node.getMetaData().get("customAsync"));
    ...
    protected void readIoSpecification(org.w3c.dom.Node xmlNode, Map<String, String> dataInputs, Map<String, String> dataOutputs, Map<String, String> dataInputTypes,
            Map<String, String> dataOutputTypes, ExtensibleXmlParser parser) {
    ...
    protected void writeIO(SubProcessNode subProcessNode, StringBuilder xmlDump) {
        ...
        for (Map.Entry<String, String> entry : subProcessNode.getInMappings().entrySet()) {
            xmlDump.append("        <dataInput id=\"" + XmlBPMNProcessDumper.getUniqueNodeId(subProcessNode) + "_" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(entry.getKey())
        ...
        for (Map.Entry<String, String> entry : subProcessNode.getOutMappings().entrySet()) {
            xmlDump.append("        <dataOutput id=\"" + XmlBPMNProcessDumper.getUniqueNodeId(subProcessNode) + "_" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(entry.getKey())
