...
public class TimerNodeInstance extends StateBasedNodeInstance implements EventListener {
    ...
    public void internalTrigger(KogitoNodeInstance from, String type) {
        ...
        JobsService jobService = KogitoProcessRuntime
                .asKogitoProcessRuntime(getProcessInstance().getKnowledgeRuntime().getProcessRuntime()).getJobsService();
    ...
    public Set<EventDescription<?>> getEventDescriptions() {
        ...
        return Collections.singleton(new BaseEventDescription(TIMER_TRIGGERED_EVENT, getNodeDefinitionId(), getNodeName(),
                "timer", getStringId(), getProcessInstance().getStringId(), null, properties));
    }
}
