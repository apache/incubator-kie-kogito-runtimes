...
public class PredictionRuntimeBuildGeneratorProvider implements RuntimeBuildGeneratorProvider {

    @Override
    public Optional<Generator> buildCodegenGenerator(KogitoBuildContext context, Collection<CollectedResource> resources) {
        return Optional.of(PredictionCodegen.ofCollectedResources(context, resources));
    }
