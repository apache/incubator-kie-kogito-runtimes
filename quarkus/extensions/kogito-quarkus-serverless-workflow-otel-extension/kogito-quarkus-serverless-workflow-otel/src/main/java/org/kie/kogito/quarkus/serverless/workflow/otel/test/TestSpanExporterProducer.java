...
public class TestSpanExporterProducer {
    ...
    void onStart(@Observes StartupEvent ev) {
        LOGGER.debug("=== TestSpanExporterProducer: Application startup - ready to produce SpanExporter ===");
    }

    @Produces
    @Singleton
    public SpanExporter spanExporter() {
        LOGGER.debug("=== TestSpanExporterProducer: Creating InMemorySpanExporter ===");
    ...
    public static class InMemorySpanExporter implements SpanExporter {
        ...
        public CompletableResultCode export(Collection<SpanData> spanDataList) {
            EXPORTER_LOGGER.debug("=== InMemorySpanExporter.export called with {} spans ===", spanDataList.size());
            ...
            EXPORTER_LOGGER.debug("=== Total spans now: {} ===", spans.size());
