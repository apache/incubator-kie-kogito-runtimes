...
public class SignalProcessInstanceAction implements Action, Serializable {
    ...
    public SignalProcessInstanceAction(String signalName, Function<KogitoProcessContext, Object> eventDataSupplier,
            String scope) {
        this.signalNameTemplate = signalName;
    ...
    public void execute(KogitoProcessContext context) throws Exception {
        ...
        if (transformation != null) {
            signal = new org.jbpm.process.core.event.EventTransformerImpl(transformation)
