...
public class RuleUnitHandler {
    ...
    public RuleUnitHandler(KogitoRuleUnitDescription ruleUnit, ProcessContextMetaModel variableScope, RuleSetNode ruleSetNode,
    ...
    private BlockStmt unbind(ProcessContextMetaModel variableScope, RuleSetNode node,
            KogitoRuleUnitDescription unitDescription) {
        RuleUnitMetaModel unit =
                new RuleUnitMetaModel(unitDescription, "unit", assignableChecker);
    ...
    public static MethodCallExpr requireNonNull(String targetProcessVar, String message) {
        return new MethodCallExpr().setScope(new NameExpr("java.util.Objects"))
                .setName("requireNonNull").addArgument(new NameExpr(targetProcessVar))
