...
public class $Type$Resource {
    ...
    public $Type$Output completeTask(@PathVariable("id") final String id,
        ...
        return processService.taskTransition(process, id, taskId, phase, SecurityPolicy.of(IdentityProviders.of(name, groups)), model)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }
    ...
    public $TaskOutput$ saveTask(@PathVariable("id") final String id,
                                 ...
                                 @RequestBody(required = false) final $TaskOutput$ model) {
        return processService.saveTask(process, id, taskId, SecurityPolicy.of(IdentityProviders.of(name, groups)), model, $TaskOutput$::fromMap)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }
    ...
    public $Type$Output taskTransition(@PathVariable("id") final String id,
                                       ...
                                       @RequestBody(required = false) final $TaskOutput$ model) {
        return processService.taskTransition(process, id, taskId, phase, SecurityPolicy.of(IdentityProviders.of(name, groups)), null)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }
    ...
    public $TaskModel$ getTask(@PathVariable("id") String id,
                               ...
                               @RequestParam(value = "group",
                                       required = false) final List<String> groups) {
        return processService.getTask(process, id, taskId, SecurityPolicy.of(IdentityProviders.of(name, groups)), $TaskModel$::from)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }
    ...
    public $Type$Output abortTask(@PathVariable("id") final String id,
                                  ...
                                  @RequestParam(value = "group",
                                          required = false) final List<String> groups) {
        return processService.abortTask(process, id, taskId, phase, SecurityPolicy.of(IdentityProviders.of(name, groups)))
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }
    ...
    public Map<String, Object> getSchemaAndPhases(@PathVariable("id") final String id,
                                                  ...
                                                  @RequestParam(value = "group",
                                                          required = false) final List<String> groups) {
        return processService.getSchemaAndPhases(process, id, taskId, "$taskName$", SecurityPolicy.of(IdentityProviders.of(name, groups)));
    }
    ...
    public ResponseEntity<Comment> addComment(@PathVariable("id") final String id,
        ...
        return processService.addComment(process, id, taskId, SecurityPolicy.of(IdentityProviders.of(name, groups)), commentInfo)
    ...
    public Comment updateComment(@PathVariable("id") final String id,
        ...
        return processService.updateComment(process, id, taskId, commentId, SecurityPolicy.of(IdentityProviders.of(name, groups)), comment)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }
    ...
    public ResponseEntity deleteComment(@PathVariable("id") final String id,
                                        ...
                                        @RequestParam(value = "user", required = false) final String user,
                                        @RequestParam(value = "group", required = false) final List<String> groups) {
        return processService.deleteComment(process, id, taskId, commentId, SecurityPolicy.of(IdentityProviders.of(name, groups)))
    ...
    public ResponseEntity<Attachment> addAttachment(@PathVariable("id") final String id,
                                                    ...
                                                    UriComponentsBuilder uriComponentsBuilder) {
        return processService.addAttachment(process, id, taskId, SecurityPolicy.of(IdentityProviders.of(name, groups)), attachmentInfo)
    ...
    public Attachment updateAttachment(@PathVariable("id") final String id,
        ...
        return processService.updateAttachment(process, id, taskId, attachmentId, SecurityPolicy.of(IdentityProviders.of(name, groups)), attachment)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }
    ...
    public ResponseEntity deleteAttachment(@PathVariable("id") final String id,
        ...
        return processService.deleteAttachment(process, id, taskId, attachmentId, SecurityPolicy.of(IdentityProviders.of(name, groups)))
    ...
    public Attachment getAttachment(@PathVariable("id") final String id,
                                    ...
                                    @RequestParam(value = "group",
                                            required = false) final List<String> groups) {
        return processService.getAttachment(process, id, taskId, attachmentId, SecurityPolicy.of(IdentityProviders.of(name, groups)))
    ...
    public Collection<Attachment> getAttachments(@PathVariable("id") final String id,
        ...
        return processService.getAttachments(process, id, taskId, SecurityPolicy.of(IdentityProviders.of(name, groups)))
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }
    ...
    public Comment getComment(@PathVariable("id") final String id,
                              ...
                              @RequestParam(value = "group",
                                      required = false) final List<String> groups) {
        return processService.getComment(process, id, taskId, commentId, SecurityPolicy.of(IdentityProviders.of(name, groups)))
    ...
    public Collection<Comment> getComments(@PathVariable("id") final String id,
                                           ...
                                           @RequestParam(value = "group",
                                                   required = false) final List<String> groups) {
        return processService.getComments(process, id, taskId, SecurityPolicy.of(IdentityProviders.of(name, groups)))
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }
}