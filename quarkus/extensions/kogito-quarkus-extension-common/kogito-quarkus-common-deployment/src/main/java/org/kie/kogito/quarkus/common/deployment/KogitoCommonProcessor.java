...
public class KogitoCommonProcessor {
    ...
    @BuildStep
    public NativeImageResourceBuildItem commonSPIResource() {
        logger.debug("commonSPIResource()");
        return new NativeImageResourceBuildItem("META-INF/services/org.kie.api.internal.runtime.KieRuntimes");
    }

    @BuildStep
    public ReflectiveClassBuildItem commonSPIReflectiveClass() {
        logger.debug("commonSPIReflectiveClass()");
