...
abstract class Repository {
    ...
    static final String INSERT = "INSERT INTO process_instances (id, payload, process_id, process_version, root_process_id, version) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    abstract void insertInternal(String processId, String processVersion, String rootProcessId, UUID id, byte[] payload, String businessKey, String[] eventTypes);
