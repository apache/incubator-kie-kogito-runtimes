...
public class KogitoEfestoProcessor {
    ...
    @BuildStep
    public List<ReflectiveClassBuildItem> reflectiveEfesto(KogitoGeneratedSourcesBuildItem sources) {
        LOGGER.infof("reflectiveEfesto {}", sources);
        ...
        Map<GeneratedFileType, List<GeneratedFile>> mappedGeneratedFiles = sources.getGeneratedFiles().stream()
