...
public class CompositeContextNodeInstanceReader implements NodeInstanceReader {
    ...
    public boolean accept(Any value) {
        return value.is(CompositeContextNodeInstanceContent.class);
    }

    @Override
    public NodeInstance read(MarshallerReaderContext context, Any marshalled) {
        try {
            CompositeContextNodeInstanceContent content = marshalled.unpack(CompositeContextNodeInstanceContent.class);
