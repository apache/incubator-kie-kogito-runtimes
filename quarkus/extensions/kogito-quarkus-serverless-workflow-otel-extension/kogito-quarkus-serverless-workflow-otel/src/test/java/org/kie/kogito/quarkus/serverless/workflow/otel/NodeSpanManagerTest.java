...
public class NodeSpanManagerTest {
    ...
    private SonataFlowOtelConfig createMockConfig(boolean enabled, boolean nodeSpansEnabled) {
        ...
        SonataFlowOtelConfig.NodeSpanConfig mockNodeSpanConfig = mock(SonataFlowOtelConfig.NodeSpanConfig.class);
        ...
        when(mockSpanConfig.nodes()).thenReturn(mockNodeSpanConfig);
        when(mockNodeSpanConfig.enabled()).thenReturn(nodeSpansEnabled);
    ...
    public void shouldReturnNullWhenSpansDisabled() throws Exception {
        io.opentelemetry.api.trace.Tracer mockTracer = mock(io.opentelemetry.api.trace.Tracer.class);
        SonataFlowOtelConfig mockConfig = createMockConfig(true, false); // nodeSpans disabled
        NodeSpanManager spanManager = new NodeSpanManager(mockTracer, mockConfig);
