...
public class KogitoProcessRuntimeImpl implements KogitoProcessRuntime {
    ...
    public void abortProcessInstance(String processInstanceId) {
        ...
        ((org.jbpm.process.instance.ProcessInstance) processInstance)
                .setState(org.kie.api.runtime.process.ProcessInstance.STATE_ABORTED);
    }
    ...
    public KogitoProcessInstance startProcess(String processId, Map<String, Object> parameters, String trigger,
