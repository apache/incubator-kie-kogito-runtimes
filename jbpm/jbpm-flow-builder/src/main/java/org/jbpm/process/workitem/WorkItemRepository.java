        ...
        for (Map<String, Object> workDefinitionMap : workDefinitionsMaps) {
            if (workDefinitionMap != null) {
                ...
                if (workDefinitionMap.get("dependencies") != null) {
                    workDefinition
                            .setDependencies(((List<String>) workDefinitionMap.get("dependencies")).toArray(new String[0]));
                }

                if (workDefinitionMap.get("mavenDependencies") != null) {
                    workDefinition.setMavenDependencies(
                            ((List<String>) workDefinitionMap.get("mavenDependencies")).toArray(new String[0]));
                }
