                        ...
                        .addArgument(
                                new ObjectCreationExpr(
                                        ...
                                        new ClassOrInterfaceType(
                                                null,
                                                listener.getPackageDeclaration().map(pd -> pd.getName().toString()).orElse("")
                                                        + "." + clazz.getName()),
                                        NodeList.nodeList()));
        ...
        if (!processMetaData.getSubProcesses().isEmpty()) {
            ...
            for (Entry<String, String> subProcess : processMetaData.getSubProcesses().entrySet()) {
                ...
                ClassOrInterfaceType modelType = new ClassOrInterfaceType(null,
                        new SimpleName(org.kie.kogito.process.Process.class.getCanonicalName()),
                ...
                if (context.hasDI()) {
                    ...
                    constructor.getBody().addStatement(new AssignExpr(new FieldAccessExpr(new ThisExpr(), fieldName),
