...
public class ModelMetaData {
    ...
    private CompilationUnit compilationUnit() {
            ...
            modelClass.addAnnotation(new NormalAnnotationExpr(new Name(Generated.class.getCanonicalName()),
                    NodeList.nodeList(new MemberValuePair("value", new StringLiteralExpr("kogito-codegen")),
                            ...
                            new MemberValuePair("name",
                                    new StringLiteralExpr(ucFirst(ProcessToExecModelGenerator.extractProcessId(processId)))),
        ...
        for (Map.Entry<String, Variable> variable : variableScope.getTypes().entrySet()) {
            ...
            fd.addAnnotation(new NormalAnnotationExpr(new Name(VariableInfo.class.getCanonicalName()), NodeList.nodeList(
                    new MemberValuePair("tags", new StringLiteralExpr(tags.stream().collect(Collectors.joining(",")))))));
