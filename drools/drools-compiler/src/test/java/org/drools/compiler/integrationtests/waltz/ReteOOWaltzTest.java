 ...
 */
public class ReteOOWaltzTest extends CommonTestMethodBase {
    ...
    private void loadLines(final KieSession kSession,
        ...
        final BufferedReader reader = new BufferedReader( new InputStreamReader( ReteOOWaltzTest.class.getResourceAsStream( filename ) ) );
