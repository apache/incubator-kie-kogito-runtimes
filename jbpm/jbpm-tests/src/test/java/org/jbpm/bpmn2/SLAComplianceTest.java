...
public class SLAComplianceTest extends JbpmBpmn2TestCase {
    ...
    public void testSLAonProcessViolatedWithExpression() throws Exception {
        ...
        kruntime = createKogitoProcessRuntime("org/jbpm/bpmn2/sla/BPMN2-UserTaskWithSLAExpr.bpmn2");
        ...
        KogitoProcessInstance processInstance = kruntime.startProcess("UserTaskWithSLAExpr", parameters);
        assertThat(processInstance.getState()).isEqualTo(KogitoProcessInstance.STATE_ACTIVE);
