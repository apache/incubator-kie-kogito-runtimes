...
/**
 * Integration test for UserTask Storage with H2 database.
...
@Transactional
public class H2SpringBootJPAUserTaskInstancesTest extends BaseSpringBootJPAUserTaskInstancesTest {

    @Autowired
    public H2SpringBootJPAUserTaskInstancesTest(SpringBootJPAUserTaskInstances userTaskInstances,
