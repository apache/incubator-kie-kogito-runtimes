    ...
    protected void visitProcess(WorkflowProcess process, StringBuilder xmlDump, int metaDataType) {
        ...
        xmlDump.append(
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?> " + EOL +
                        ...
                        (metaDataType == META_DATA_USING_DI ? "             xmlns:bpmndi=\"http://www.omg.org/spec/BPMN/20100524/DI\"" + EOL +
        ...
        for (org.kie.api.definition.process.Node node : nodes) {
            if (node instanceof WorkItemNode) {
                    ...
                    if ("Service Task".equals(work.getName())) {
                        ...
                        xmlDump.append(
                                "  <itemDefinition id=\"" + getUniqueNodeId(node) + "_InMessageType\" " +
                                        ("".equals(parameterType) || "java.lang.Object".equals(parameterType) ? "" : "structureRef=\"" + parameterType + "\" ")
                                        + "/>" + EOL +
                ...
                if (messageType != null) {
                    xmlDump.append(
                            "  <itemDefinition id=\"" + getUniqueNodeId(node) + "_MessageType\" " +
                                    ("".equals(messageType) || "java.lang.Object".equals(messageType) ? "" : "structureRef=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(messageType) + "\" ")
                                    + "/>" + EOL +
                                    "  <message id=\"" + getUniqueNodeId(node) + "_Message\" itemRef=\"" + getUniqueNodeId(node) + "_MessageType\" />" + EOL + EOL);
                }
                    ...
                    if (messageRef.startsWith("Message-")) {
                        ...
                        xmlDump.append(
                                "  <itemDefinition id=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(messageRef) + "Type\" " +
                                        ...
                                        +
                                        "/>" + EOL +
                                        "  <message id=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(messageRef) + "\" itemRef=\""
                                        + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(messageRef) + "Type\" />" + EOL + EOL);
                    }
                }
                        ...
                        if (eventType.startsWith("Message-")) {
                            ...
                            xmlDump.append(
                                    "  <itemDefinition id=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(eventType) + "Type\" " +
                                            ...
                                            +
                                            "/>" + EOL +
                                            "  <message id=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(eventType) + "\" itemRef=\""
                                            + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(eventType) + "Type\" />" + EOL + EOL);
                        }
                    }
                }
            ...
            if (node instanceof FaultNode) {
                ...
                if (!faultNode.isTerminateParent()) {
                    ...
                    if (!escalations.contains(escalationCode)) {
                        ...
                        xmlDump.append(
                                "  <escalation id=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(escalationCode) + "\" escalationCode=\""
                    ...
                    if (action != null) {
                        ...
                        if (s.startsWith(
                            ...
                            if (!escalations.contains(type)) {
                                ...
                                xmlDump.append(
                                        "  <escalation id=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(type) + "\" escalationCode=\""
