...
public class ProcessToExecModelGenerator {
    ...
    public ProcessMetaData generate(WorkflowProcess process) {
        ...
        processMethod.ifPresent(methodDeclaration -> {
            processVisitor.visitProcess(process, methodDeclaration, metadata);
        });
    ...
    private boolean isCase(WorkflowProcess process) {
        return process instanceof org.jbpm.workflow.core.WorkflowProcess &&
            ((org.jbpm.workflow.core.WorkflowProcess)process).isDynamic();
    }
