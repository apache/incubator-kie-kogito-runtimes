...
public class PersistenceGenerator extends AbstractGenerator {
    ...
    public static final String DEFAULT_PERSISTENCE_TYPE = JDBC_PERSISTENCE_TYPE;
    ...
    /**
     * (string) kind of persistence used; possible values: filesystem, mongodb, postgresql, kafka, jdbc; default to jdbc
     */
