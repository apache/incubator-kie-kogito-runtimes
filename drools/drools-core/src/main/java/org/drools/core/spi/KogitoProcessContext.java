...
public class KogitoProcessContext implements org.kie.api.runtime.process.ProcessContext {
    ...
    public KogitoProcessContext setNodeInstance(NodeInstance nodeInstance) {
