...
public class BoundaryEventHandler extends AbstractNodeHandler {
                ...
                if (errorRef != null && errorRef.trim().length() > 0) {
                    ...
                    if (structureRef != null) {
                        Map<String, ItemDefinition> itemDefs =
                                (Map<String, ItemDefinition>) ((ProcessBuildData) parser.getData())
    ...
    protected void handleCompensationNode(final Node node, final Element element, final String uri,
        ...
        ProcessHandler.addCompensationScope((RuleFlowProcess) parser.getParent(RuleFlowProcess.class), eventNode,
