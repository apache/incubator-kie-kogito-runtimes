...
public class DMNKogitoTest {
    ...
    public void testBasic() {
        ...
        assertThat(kogitoAPI.getDMNModel().getInputs().size()).as("Traffic Violation model has 2 inputs").isEqualTo(2);
    }
    ...
    public void testProfile() {
        ...
        assertThat(dmnModel.getMessages(Severity.ERROR).size()).isEqualTo(0); // nn any() is a Kie-extended built-in function.
    }
}
