...
public class CodegenSvgTest {
    ...
    public void testExistingAutogeneratedSVGRenamedAndMoved(KogitoBuildContext.Builder contextBuilder) {
    ...
    @ParameterizedTest
    @MethodSource("org.kie.kogito.codegen.api.utils.KogitoContextTestUtils#contextBuilders")
    public void testNoWithoutSVGAddonNoRenamedAndMoved(KogitoBuildContext.Builder contextBuilder) {
