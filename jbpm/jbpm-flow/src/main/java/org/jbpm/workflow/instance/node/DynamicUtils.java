...
public class DynamicUtils {
        ...
        if (ksession instanceof StatefulKnowledgeSessionImpl) {
            ...
            runner.execute(new ExecutableCommand<Void>() {
                ...
                public Void execute(Context context) {
                    ...
                    WorkflowProcessInstance realProcessInstance =
                            (WorkflowProcessInstance) kruntime.getProcessInstance(processInstance.getStringId());
            ...
            throw new IllegalArgumentException(
                    "Unsupported ksession: " + ksession == null ? "null" : ksession.getClass().getName());
        }
    }
    ...
    private static void executeWorkItem(StatefulKnowledgeSessionImpl ksession,
        ...
        KogitoProcessEventSupport eventSupport =
                ((InternalProcessRuntime) ksession.getProcessRuntime()).getProcessEventSupport();
    ...
    private static String executeSubProcess(StatefulKnowledgeSessionImpl ksession,
        ...
        if (process == null) {
            ...
            subProcessInstance =
                    (ProcessInstance) kogitoSession.getKogitoProcessRuntime().startProcessInstance(subProcessInstanceId);
