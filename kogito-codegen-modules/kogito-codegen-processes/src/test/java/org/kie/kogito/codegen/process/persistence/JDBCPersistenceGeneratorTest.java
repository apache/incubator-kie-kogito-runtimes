...
class JDBCPersistenceGeneratorTest {
    ...
    void test(KogitoBuildContext.Builder contextBuilder) {
        ...
        context.setApplicationProperty("kogito.persistence.type", JDBC_PERSISTENCE_TYPE);
        ...
        PersistenceGenerator persistenceGenerator = new PersistenceGenerator(
                context,
                protoGenerator);
        assertEquals(PersistenceGenerator.JDBC_PERSISTENCE_TYPE, persistenceGenerator.persistenceType());
