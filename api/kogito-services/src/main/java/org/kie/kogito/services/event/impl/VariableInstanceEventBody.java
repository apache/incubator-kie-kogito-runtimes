...
public class VariableInstanceEventBody {
    ...
    public String toString() {
        return "VariableInstanceEventBody [variableName=" + variableName + ", variableValue=" + variableValue
                + ", variablePreviousValue=" + variablePreviousValue + ", changeDate=" + changeDate + ", changedByNodeId=" +
                changedByNodeId + ", changedByNodeName=" + changedByNodeName + ", changedByNodeType=" + changedByNodeType
                + ", changedByUser=" + changedByUser + ", processInstanceId=" + processInstanceId +
                ", rootProcessInstanceId=" + rootProcessInstanceId + ", processId=" + processId + ", rootProcessId="
                + rootProcessId + "]";
    }
