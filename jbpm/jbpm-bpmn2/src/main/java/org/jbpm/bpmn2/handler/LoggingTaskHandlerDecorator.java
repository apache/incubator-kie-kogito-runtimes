 ...
 * 
 * </p>
 * When an exception is thrown by the wrapped {@link WorkItemHandler}
 ...
 * 
 * </p>
 * After the exception info has been saved, this class then logs a message
...
public class LoggingTaskHandlerDecorator extends AbstractExceptionHandlingTaskHandler {
     ...
     * 
     * </p>
     * The default {@link MessageFormat} string used is one of the
     * following:
     * 
     * </p>
     * If the {@link WorkItemHandler} is a {@link ServiceTaskHandler} (that
     ...
     * 
     * </p>
     * For all other {@link WorkItemHandler} implementations, the format is:
     * <ul>
     ...
     * 
     * </p>
     * The order of the {@link InputParameter} value in the list corresponds to the {@link MessageFormat} number
     * used in the String given to {@link LoggingTaskHandlerDecorator#setLoggedMessageFormat(String)}.
     * 
     * </p>
     * See {@link InputParameter} for more information.
     * 
     ...
     * 
     * <p>
     * Work items are referred to in the following table, are {@link WorkItem} instances
     ...
     * <td>If the work item was being processed as part of a &lt;serviceTask&gt;, then this is the name of the class or service
     * being called. Null otherwise.</td>
     * </tr>
     * <tr>
     * <td><code>OPERATION</code></td>
     * <td>If the work item was being processed as part of a &lt;serviceTask&gt;, then this is the name of the method or service
     * operation being called. Null otherwise.</td>
     * </tr>
     * <tr>
