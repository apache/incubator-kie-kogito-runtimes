...
public class JoinInstance extends NodeInstanceImpl {
            ...
            case Join.TYPE_N_OF_M:
                ...
                if (n.startsWith("#{") && n.endsWith("}")) {
                    ...
                    VariableScopeInstance variableScopeInstance =
                            (VariableScopeInstance) resolveContextInstance(VariableScope.VARIABLE_SCOPE, n);
    ...
    private boolean existsActiveDirectFlow(NodeInstanceContainer nodeInstanceContainer,
            final org.kie.api.definition.process.Node lookFor) {
    ...
    private boolean checkNodes(Set<Long> vistedNodes, org.kie.api.definition.process.Node startAt,
            org.kie.api.definition.process.Node currentNode, org.kie.api.definition.process.Node lookFor) {
        if (currentNode == null) {
