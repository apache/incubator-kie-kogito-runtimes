...
public class DiscoveredServiceWorkItemHandlerTest {
    ...
    public void testGivenEndpoint() throws IOException {
        ...
        Response response = new Response.Builder().body(body).protocol(Protocol.HTTP_1_1).message("test")
                .request(new Request.Builder().url("http://localhost:9000").build()).code(200).build();
