...
public abstract class StateBasedNodeFactory extends ExtendedNodeFactory {
    ...
    protected StateBasedNode getStateBasedNode() {
        return (StateBasedNode) super.getNode();
    }

    @Override
    public StateBasedNodeFactory onEntryAction(String dialect, String action) {
        super.onEntryAction(dialect, action);
        return this;
    }

    @Override
    public StateBasedNodeFactory onExitAction(String dialect, String action) {
