...
public class CodegenMessageStartEventTest {
    ...
    public void testMessageProducerForMessageEndEvent(KogitoBuildContext.Builder contextBuilder) {
        ...
        properties.put("kogito.addon.cloudevents.kafka.kogito_outgoing_stream", "test_outgoing");
        properties.put("kogito.addon.cloudevents.kafka.kogito_incoming_stream", "test_incoming");
