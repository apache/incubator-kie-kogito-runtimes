...
public class CompositeNodeInstance extends StateBasedNodeInstance
        ...
        if (nodeAndType != null) {
            ...
            for (Connection connection : connections) {
                if ((connection.getFrom() instanceof CompositeNode.CompositeNodeStart) &&
                        (from == null ||
                                ((CompositeNode.CompositeNodeStart) connection.getFrom()).getInNode().getId() == from
                                        .getNodeId())) {
    ...
    public NodeInstance getNodeInstance(final org.kie.api.definition.process.Node node) {
        ...
        NodeInstanceFactory conf = NodeInstanceFactoryRegistry
                .getInstance(getProcessInstance().getKnowledgeRuntime().getEnvironment()).getProcessNodeInstanceFactory(node);
        if (conf == null) {
