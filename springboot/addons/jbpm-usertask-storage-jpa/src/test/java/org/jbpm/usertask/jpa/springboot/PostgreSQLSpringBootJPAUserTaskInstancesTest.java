...
@Transactional
public class PostgreSQLSpringBootJPAUserTaskInstancesTest extends BaseSpringBootJPAUserTaskInstancesTest {

    @Autowired
    public PostgreSQLSpringBootJPAUserTaskInstancesTest(SpringBootJPAUserTaskInstances userTaskInstances,
