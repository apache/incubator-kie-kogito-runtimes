...
public class HumanTaskWorkItemHandler implements WorkItemHandler {
    ...
    public static boolean transitionToPhase(WorkItemHandler handler, KogitoWorkItem workItem, WorkItemManager manager,
            Transition<?> transition) {
        if (handler instanceof HumanTaskWorkItemHandler) {
            ((HumanTaskWorkItemHandler) handler).lifeCycle.transitionTo(workItem, manager,
