...
public class SplitInstance extends NodeInstanceImpl {
    ...
    protected void executeStrategy(Split split, String type) {
        ...
        switch (split.getType()) {
            ...
            case Split.TYPE_OR:
                ...
                if (!found) {
                    throw new IllegalArgumentException(
                            "OR split could not find at least one valid outgoing connection for split " + getSplit().getName());
                }
                break;
            case Split.TYPE_XAND:
                ...
                if (connections == null || connections.isEmpty()) {
                    ...
                    Map<org.jbpm.workflow.instance.NodeInstance, String> nodeInstancesMap =
    ...
    protected boolean checkNodes(org.kie.api.definition.process.Node currentNode,
            final org.kie.api.definition.process.Node lookFor, Set<Long> vistedNodes) {
