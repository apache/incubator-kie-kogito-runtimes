...
@TestTransaction
public class H2QuarkusDataIsolationTest extends AbstractUserTaskInstancesDataIsolationIT {
    ...
    @Inject
    public H2QuarkusDataIsolationTest(JPAUserTaskInstances userTaskInstances,
