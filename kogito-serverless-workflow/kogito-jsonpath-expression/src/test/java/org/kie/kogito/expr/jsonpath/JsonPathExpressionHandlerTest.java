...
class JsonPathExpressionHandlerTest {
    ...
    void testCollection() {
        ...
        assertThat(parsedExpression.isValid()).isTrue();
        assertThat(parsedExpression.eval(getObjectNode(), Collection.class, getContext())).isEqualTo(Arrays.asList("string1", 12, false, Arrays.asList(1.1, 1.2, 1.3)));
    }
    ...
    void testConstPropertyFromJsonAccessible() {
        ...
        assertThat(parsedExpression.isValid()).isTrue();
        assertThat(parsedExpression.eval(getObjectNode(), String.class, getContext())).isEqualTo("accessible_value");
    }
