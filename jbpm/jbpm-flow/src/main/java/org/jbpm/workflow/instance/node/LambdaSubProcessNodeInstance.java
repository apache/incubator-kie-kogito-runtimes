...
public class LambdaSubProcessNodeInstance extends StateBasedNodeInstance
        implements KogitoEventListener, ContextInstanceContainer {
    ...
    public void internalTrigger(KogitoNodeInstance from, String type) {
        ...
        org.kie.api.runtime.process.ProcessInstance pi =
    ...
    public void cancel() {
        ...
        if (getSubProcessNode() == null || !getSubProcessNode().isIndependent()) {
            ...
            KogitoProcessRuntime kruntime =
                    (KogitoProcessRuntime) ((ProcessInstance) getProcessInstance()).getKnowledgeRuntime();
    ...
    private void handleOutMappings(ProcessInstance processInstance) {
        ...
        org.kie.kogito.process.ProcessInstance<?> pi =
                ((org.kie.kogito.process.ProcessInstance<?>) processInstance.getMetaData().get("KogitoProcessInstance"));
        if (pi != null) {
