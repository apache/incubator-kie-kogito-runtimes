...
public class UserTaskCommentEventDataEventAdapter extends AbstractDataEventAdapter {
    ...
    public DataEvent<?> adapt(Object payload) {
        ...
        UserTaskInstanceCommentDataEvent utEvent = new UserTaskInstanceCommentDataEvent(AdapterHelper.buildSource(getConfig().service(), event.getUserTaskModel().getExternalReferenceId()),
