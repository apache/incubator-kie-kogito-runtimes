...
public class XmlBPMNProcessDumper implements XmlProcessDumper {
    ...
    private void visitSubVariableScopes(org.kie.api.definition.process.Node[] nodes, StringBuilder xmlDump,
            Set<String> dumpedItemDefs) {
    ...
    private void visitLanes(WorkflowProcess process, StringBuilder xmlDump) {
        ...
        if (!swimlanes.isEmpty()) {
            ...
            for (Swimlane swimlane : swimlanes) {
                xmlDump.append("      <lane name=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(swimlane.getName())
                        + "\" >" + EOL);
        ...
        for (org.kie.api.definition.process.Node node : container.getNodes()) {
            if (node instanceof HumanTaskNode) {
                ...
                if (lane.equals(swimlane)) {
                    xmlDump.append(
                            "        <flowNodeRef>" + XmlBPMNProcessDumper.getUniqueNodeId(node) + "</flowNodeRef>" + EOL);
                }
            } else {
            ...
            if (node instanceof WorkItemNode) {
                    ...
                    if ("Service Task".equals(work.getName())) {
                        ...
                        xmlDump.append(
                                "  <itemDefinition id=\"" + getUniqueNodeId(node) + "_InMessageType\" " +
                                        ...
                                        + "/>" + EOL +
                                        "  <message id=\"" + getUniqueNodeId(node) + "_InMessage\" itemRef=\""
                                        + getUniqueNodeId(node) + "_InMessageType\" />" + EOL +
                                        "  <interface id=\"" + getUniqueNodeId(node) + "_ServiceInterface\" name=\""
                                        + interfaceName + "\" implementationRef=\"" + interfaceRef + "\" >" + EOL +
                                        "    <operation id=\"" + getUniqueNodeId(node) + "_ServiceOperation\" name=\""
                                        + operationName + "\" implementationRef=\"" + operationRef + "\" >" + EOL +
                                ...
                                "  <itemDefinition id=\"" + getUniqueNodeId(node) + "_MessageType\" " +
                                        ("".equals(messageType) || "java.lang.Object".equals(messageType) ? ""
                                                : "structureRef=\""
                                                        ...
                                                        + "\" ")
                                        + "/>" + EOL +
                                        "  <message id=\"" + getUniqueNodeId(node) + "_Message\" itemRef=\""
                                ...
                                "  <itemDefinition id=\"" + getUniqueNodeId(node) + "_MessageType\" " +
                                        ("".equals(messageType) || "java.lang.Object".equals(messageType) ? ""
                                                : "structureRef=\""
                                                        ...
                                                        + "\" ")
                                        + "/>" + EOL +
                                        "  <message id=\"" + messageId + "\" itemRef=\"" + getUniqueNodeId(node)
                            ...
                            "  <itemDefinition id=\"" + getUniqueNodeId(node) + "_MessageType\" " +
                                    ("".equals(messageType) || "java.lang.Object".equals(messageType) ? ""
                                            : "structureRef=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(messageType)
                                                    + "\" ")
                                    + "/>" + EOL +
                                    "  <message id=\"" + getUniqueNodeId(node) + "_Message\" itemRef=\"" + getUniqueNodeId(node)
                                    + "_MessageType\" />" + EOL + EOL);
                }
                ...
                if (filters.size() > 0) {
                    ...
                    if (messageRef.startsWith("Message-")) {
                        ...
                        String messageType = (String) node.getMetaData().get("MessageType");
                        xmlDump.append(
                                "  <itemDefinition id=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(messageRef)
                                        + "Type\" " +
                                        ("".equals(messageType) || "java.lang.Object".equals(messageType) ? ""
                                                : "structureRef=\""
                                                        + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(messageType)
                                        ...
                                        +
                                        "/>" + EOL +
                                        "  <message id=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(messageRef)
                                        + "\" itemRef=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(messageRef)
                                        + "Type\" />" + EOL + EOL);
                    }
                }
                ...
                if (startNode.getTriggers() != null && !startNode.getTriggers().isEmpty()) {
                    ...
                    if (trigger instanceof EventTrigger) {
                        ...
                        if (eventType.startsWith("Message-")) {
                            ...
                            String messageType = (String) node.getMetaData().get("MessageType");
                            xmlDump.append(
                                    "  <itemDefinition id=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(eventType)
                                            + "Type\" " +
                                            ("".equals(messageType) || "java.lang.Object".equals(messageType) ? ""
                                                    : "structureRef=\""
                                                            + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(messageType)
                                            ...
                                            +
                                            "/>" + EOL +
                                            "  <message id=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(eventType)
                                            + "\" itemRef=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(eventType)
                                            + "Type\" />" + EOL + EOL);
                        }
                    }
                }
                ...
                xmlDump.append(
                        "  <itemDefinition id=\"" + XmlBPMNProcessDumper.getUniqueNodeId(forEachNode)
    ...
    protected void visitEscalations(org.kie.api.definition.process.Node[] nodes, StringBuilder xmlDump,
            ...
            if (node instanceof FaultNode) {
                ...
                if (!faultNode.isTerminateParent()) {
                    ...
                    if (!escalations.contains(escalationCode)) {
                        ...
                        xmlDump.append(
                                "  <escalation id=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(escalationCode)
                                        + "\" escalationCode=\""
                    ...
                    if (action != null) {
                        ...
                        if (s.startsWith(
                            ...
                            if (!escalations.contains(type)) {
                                ...
                                xmlDump.append(
                                        "  <escalation id=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(type)
                                                + "\" escalationCode=\""
            ...
            if (split.getType() == Split.TYPE_XOR || split.getType() == Split.TYPE_OR) {
                ...
                if (constraint == null) {
                    ...
                    if (constraint.getName() != null && constraint.getName().trim().length() > 0) {
                        xmlDump.append(
                                "name=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(constraint.getName()) + "\" ");
                    }
