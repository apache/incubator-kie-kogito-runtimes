...
public final class ServiceDiscoveryFactory {
     ...
     * 
     * @param kubeClient the {@link KogitoKubeClient} reference. If null, a new {@link DefaultKogitoKubeClient} will be created
     *        for you during the {@link ServiceDiscovery} {@link #build()}
     */
