...
public class DevModeServerlessWorkflowLogger extends DefaultKogitoProcessEventListener {
    ...
    public void beforeProcessStarted(ProcessStartedEvent event) {
        ...
        // Debug: Check if MDC is set correctly
        LOGGER.info("DEBUG: ProcessInstanceId set to: {}, MDC value: {}", processInstanceId, org.slf4j.MDC.get("processInstanceId"));
        // Test: Try direct MDC manipulation
        org.slf4j.MDC.put("processInstanceId", processInstanceId);
        LOGGER.info("TEST: After direct MDC.put, MDC value: {}", org.slf4j.MDC.get("processInstanceId"));
