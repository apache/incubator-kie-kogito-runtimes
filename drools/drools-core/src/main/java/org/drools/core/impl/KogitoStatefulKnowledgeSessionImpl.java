...
public class KogitoStatefulKnowledgeSessionImpl extends StatefulKnowledgeSessionImpl
        implements KogitoWorkingMemory, KogitoProcessRuntime.Provider {
    ...
    public KogitoStatefulKnowledgeSessionImpl(long id, InternalKnowledgeBase kBase, boolean initInitFactHandle,
            SessionConfiguration config, Environment environment) {
        super(id, kBase, initInitFactHandle, config, environment);
    }

    public KogitoStatefulKnowledgeSessionImpl(long id, InternalKnowledgeBase kBase, FactHandleFactory handleFactory,
    ...
    public Object startProcessInstance(String subProcessInstanceId) {
        throw new UnsupportedOperationException(
                "org.drools.core.impl.KogitoStatefulKnowledgeSessionImpl.startProcessInstance -> TODO");
    }
    ...
    public static class KogitoWrappedStatefulKnowledgeSessionForRHS extends WrappedStatefulKnowledgeSessionForRHS
            implements KogitoProcessRuntime.Provider {
