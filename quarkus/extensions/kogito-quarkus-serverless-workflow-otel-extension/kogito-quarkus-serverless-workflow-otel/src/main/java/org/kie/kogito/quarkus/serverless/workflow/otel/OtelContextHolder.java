...
import static org.kie.kogito.quarkus.serverless.workflow.otel.SonataFlowOtelAttributes.MDCKeys;
...
public class OtelContextHolder {
    ...
    private static final Map<String, String> processStartContexts = new ConcurrentHashMap<>();
    private static final Map<String, ProcessCompletionContext> processCompletionContexts = new ConcurrentHashMap<>();
    ...
    public static void setProcessStartContext(String processInstanceId, String transactionId) {
        if (processInstanceId != null && transactionId != null) {
            processStartContexts.put(processInstanceId, transactionId);
        }
    }

    public static String getProcessStartContext(String processInstanceId) {
        return processStartContexts.get(processInstanceId);
    }
    ...
    public static void setProcessCompletionContext(String processInstanceId, long durationMs, String outcome) {
        if (processInstanceId != null) {
            processCompletionContexts.put(processInstanceId, new ProcessCompletionContext(durationMs, outcome));
        }
    }

    public static ProcessCompletionContext getProcessCompletionContext(String processInstanceId) {
        return processCompletionContexts.get(processInstanceId);
    }
