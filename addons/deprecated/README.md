...
| Persistence File System | kogito-addons-persistence-filesystem          | kogito-addons-springboot-persistence-filesystem | 1.20.0 |
| Persistence Infinispan  | kogito-addons-persistence-infinispan          | kogito-addons-springboot-persistence-infinispan | 1.20.0 |
| Persistence JDBC        | kogito-addons-persistence-jdbc                | kogito-addons-springboot-persistence-jdbc       | 1.20.0 |
| Persistence MongoDB     | kogito-addons-persistence-mongodb             | kogito-addons-springboot-persistence-mongodb | 1.20.0 |
